###############################################################################
# Program: DataUtils.py
# Description: Data Utilities for NMT.
###############################################################################
...
class DataUtils:
    ...
    def create_vocabulary(self, vocabulary_path, data_path, max_vocabulary_size,
      ...
      """
      if not gfile.Exists(self, vocabulary_path):
    ...
    def prepare_data(self, data_dir, from_train_path, to_train_path, from_dev_path, to_dev_path, from_vocabulary_size,
